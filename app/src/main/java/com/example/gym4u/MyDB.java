...
class MyDB extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_IMAGE = "CREATE TABLE " + TABLE_NAME + "( " +KEY_ID +" INTEGER PRIMARY KEY AUTOINCREMENT, "+ KEY_NAME + " TEXT NOT NULL," + KEY_IMAGE + " BLOB, " + KEY_POST + " TEXT NOT NULL, "+KEY_DATE+ "TEXT NOT NULL, " + KEY_TIME+ "TEXT NOT NULL);";
    ...
    public void insert(String name, String post, String date, String time) throws SQLException {
    ...
    */
    public List<Postdata> getEverything(){
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                post.setPost(cursor.getString(3));
